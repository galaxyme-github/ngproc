...
<div class="comment-content-wrapper">
	<div class="comment-meta">
		...
		<?php echo monstroid2_get_comment_date( array( 'format' => 'F j, Y \a\t g:ia' ) ); ?>
	</div>
	<div class="comment-content">
		<?php echo monstroid2_get_comment_text(); ?>
	</div>
	<div class="reply">
		<?php echo monstroid2_get_comment_reply_link( array( 'reply_text' => '<i class="fa fa-reply" aria-hidden="true"></i>reply' ) ); ?>
	</div>
</div>
