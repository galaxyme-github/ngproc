 ...
 */
function monstroid2_rewrite_comment_item( $_comment, $args, $depth ) {
	global $comment;

	$_comment->monstroid2_comment_list_args = $args;
	$comment = $_comment;
 ...
 */
function monstroid2_comment_author_avatar( $args = array() ) {
	global $comment;

	if ( ! empty( $comment->monstroid2_comment_list_args['avatar_size'] ) ) {
		$size = $comment->monstroid2_comment_list_args['avatar_size'];
	}
	 ...
	 * @param array $args   Arguments.
	 */
	return apply_filters( 'monstroid2-theme/comments/author-avatar', get_avatar( $comment, $size ), $args );
}
 ...
 */
function monstroid2_get_comment_author_link( $args = array() ) {
	/**
	 ...
	 * @param array $args   Arguments.
	 */
	return apply_filters( 'monstroid2-theme/comments/author-link', sprintf( '<b class="fn">%s</b>', get_comment_author_link() ), $args );
}
 ...
 */
function monstroid2_get_comment_date( $args = array() ) {
	 ...
	 * @param array  $args   Arguments.
	 */
	return apply_filters( 'monstroid2-theme/comments/date', sprintf( 
 ...
 */
function monstroid2_get_comment_text( $args = array() ) {
	 ...
	 * @param array  $args         Arguments.
	 */
	return apply_filters( 'monstroid2-theme/comments/text', $comment_text, $args );
}
 ...
 */
function monstroid2_get_comment_reply_link( $args = array() ) {
	global $comment_depth;
	 ...
	 * @param array  $args  Arguments.
	 */
	return apply_filters( 'monstroid2-theme/comments/reply_link', $reply, $args );
}
 ...
 */
function monstroid2_get_comment_link_edit( $args = array() ) {
	global $comment;

	$text = esc_html__( 'Edit', 'monstroid2' );
	 ...
	 * @param array  $args       Arguments.
	 */
	return apply_filters( 'monstroid2-theme/comments/link-edit', $link, $comment->comment_ID, $args );
}
