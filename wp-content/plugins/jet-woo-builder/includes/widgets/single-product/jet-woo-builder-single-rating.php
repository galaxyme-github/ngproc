	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			...
			array(
				...
				'stars'          => '.jet-woo-builder.elementor-jet-single-rating .star-rating',
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['stars'] => 'color: {{VALUE}}',
					'{{WRAPPER}} ' . $css_scheme['stars'] . ':before' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['stars'] . ' > span:before' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} ' . $css_scheme['stars'] => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
