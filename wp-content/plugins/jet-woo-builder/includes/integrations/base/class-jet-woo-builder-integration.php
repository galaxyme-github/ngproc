...
if ( ! class_exists( 'Jet_Woo_Builder_Integration' ) ) {
	...
	class Jet_Woo_Builder_Integration {
		...
		/**
		 * Hloder for current product instance
		 *
		 * @var array
		 */
		...
		public function register_widgets( $widgets_manager ) {
			...
			require jet_woo_builder()->plugin_path( 'includes/base/class-jet-woo-builder-base.php' );
			...
			if ( is_admin() && get_post_type() !== jet_woo_builder_post_type()->slug() ) {
				return;
			}
