...
<div class="about__section is-feature has-subtle-background-color">
	...
	<p>
		<?php
		_e( 'Use the buttons below to enable desired catalog mode.', 'ecommerce-product-catalog' );
		?>
	</p>
	<p>
		<?php
		_e( 'You can make additional adjustments in settings later.', 'ecommerce-product-catalog' );
		?>
	</p>
</div>
...
<div class="about__section has-2-columns">
	<div class="column">
		...
		<p><a class="button-primary" href="<?php echo esc_url( add_query_arg( 'mode', 'store', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>"><?php _e( 'Enable Web Store Mode', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
...
<div class="about__section has-2-columns has-accent-background-color">
	<div class="column">
		...
		<p><a class="button-primary" href="<?php echo esc_url( add_query_arg( 'mode', 'inquiry', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>"><?php _e( 'Enable Inquiry Catalog Mode', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
	<div class="column"></div>
</div>
...
<div class="about__section has-2-columns has-subtle-background-color">
	<div class="column">
		...
		<p><a class="button-primary" href="<?php echo esc_url( add_query_arg( 'mode', 'affiliate', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>"><?php _e( 'Enable Affiliate Catalog Mode', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
	<div class="column"></div>
</div>
...
<div class="about__section has-2-columns">
	<div class="column">
		...
		<p><?php _e( 'Enable this option if you just want to display products.', 'ecommerce-product-catalog' ) ?></p>
		<p><a class="button-primary" href="<?php echo esc_url( add_query_arg( 'mode', 'simple', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>"><?php _e( 'Enable Simple Catalog Mode', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
	<div class="column"></div>
</div>
...
<div class="about__section has-subtle-background-color has-2-columns">
	...
	<div class="column">
		...
		<p><a taget="_blank" href="https://implecode.com/wordpress/product-catalog/theme-integration-guide/#theme_integration"><?php _e( 'Check the advanced theme integration method', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
	<div class="column">
		...
		<p><a target="_blank" href="https://implecode.com/docs/ecommerce-product-catalog/product-page-template/"><?php _e( 'Check the details about template modification', 'ecommerce-product-catalog' ); ?></a></p>
	</div>
</div>
...
<div class="about__section has-subtle-background-color has-2-columns">
	<div class="column">
		...
		<p><a target="_blank" href="https://implecode.com/docs/ecommerce-product-catalog/product-catalog-shortcodes/"><?php _e( 'Check all the shortcodes', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
	<div class="column">
		...
		<p><a target="_blank" href="https://implecode.com/docs/ecommerce-product-catalog/css-adjustments/#cam=welcome&key=css"><?php _e( 'CSS code snippets', 'ecommerce-product-catalog' ) ?></a> | <a target="_blank" href="https://implecode.com/docs/ecommerce-product-catalog/php-adjustments/#cam=welcome&key=php"><?php _e( 'PHP code snippets', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
</div>
...
<div class="about__section has-2-columns has-subtle-background-color is-wider-right">
	<div class="column">
		...
		<p><a href="https://implecode.com/support/?support_type=custom_job" class="button-primary" target="_blank"><?php _e( 'Contact the developers', 'ecommerce-product-catalog' ) ?></a></p>
	</div>
