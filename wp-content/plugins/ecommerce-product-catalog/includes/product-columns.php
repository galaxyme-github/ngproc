...
function ic_admin_products_custom_tabs() {
	...
	?>
	<a id="al_products" class="nav-tab<?php echo $class ?>" href="<?php echo admin_url( 'edit.php?post_type=al_product' ) ?>"><?php echo get_catalog_names( 'plural' ) ?></a>
	<a id="al_categories" class="nav-tab<?php echo $category_class ?>" href="<?php echo admin_url( 'edit-tags.php?taxonomy=al_product-cat&post_type=al_product' ) ?>"><?php echo __( 'Categories', 'ecommerce-product-catalog' ) ?></a>
	<?php
}
...
function ic_admin_add_new_custom_tabs() {
	if ( current_user_can( 'publish_products' ) ) {
		?>
		<a id="add-new-product-page" class="page-title-action" href="<?php echo admin_url( 'post-new.php?post_type=al_product' ) ?>"><?php echo sprintf( __( 'Add new %s', 'ecommerce-product-catalog' ), get_catalog_names( 'singular' ) ) ?></a>
		<?php
	}
}
