		...
		<tbody>
			<tr id="default-theme">
				<td class="with-additional-styling theme-name">
					<label><input type="radio" name="archive_template" value="default" <?php checked( 'default' == $archive_template ); ?>><?php _e( 'Modern Grid', 'ecommerce-product-catalog' ); ?></label></td>
			...
			<tr>
				<td class="additional-styling">
					...
					?>: <input type="number" min="1" max="5" step="1" class="number_box" name="modern_grid_settings[per-row]" value="<?php echo $modern_grid_settings[ 'per-row' ] ?>"><?php echo $item_name ?><br>
			...
			<tr id="list-theme">
				<td class="with-additional-styling theme-name">
					<label><input type="radio" name="archive_template" value="list" <?php checked( 'list' == $archive_template ); ?>><?php _e( 'Classic List', 'ecommerce-product-catalog' ); ?></label></td>
			...
			<tr id="grid-theme">
				<td class="with-additional-styling theme-name">
					<label><input type="radio" name="archive_template" value="grid" <?php checked( 'grid' == $archive_template ); ?>><?php _e( 'Classic Grid', 'ecommerce-product-catalog' ); ?></label></td>
			...
			<tr>
				<td class="additional-styling">
					...
					_e( 'Per row', 'ecommerce-product-catalog' )
					?>: <input type="number" min="1" step="1" class="number_box" title="<?php _e( 'The product listing element width will adjust accordingly to your theme content width.', 'ecommerce-product-catalog' ) ?>" name="classic_grid_settings[entries]" value="<?php echo $classic_grid_settings[ 'entries' ] ?>"><?php echo $item_name ?><br>
