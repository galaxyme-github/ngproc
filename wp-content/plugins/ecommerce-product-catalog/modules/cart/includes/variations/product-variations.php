 ...
 */
function get_variations_modificators( $product_id = null, $selected = null, $variation_id = null, $format = true,
									  $price_value = null ) {
 ...
 * @return type
 */
function get_variations_shipping_modificators( $product_id = null, $selected = null, $variation_id = null,
...
add_filter( 'post_class', 'add_variations_product_class', 10, 3 );
 ...
 * @return string
 */
function add_variations_product_class( $product_class, $class, $product_id ) {
