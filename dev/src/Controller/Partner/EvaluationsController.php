...
class EvaluationsController extends AppController
{
    ...
    public function index()
    {
        ...
        $evaluations = $this->Evaluations->find('all', ['contain' => ['Client', 'Cotations' => 'Purchases' ]])->where(['parter_id' => $user->id, 'owner' => 'parter',  'Evaluations.value' => 0, 'Purchases.status' => 3])->toList();
