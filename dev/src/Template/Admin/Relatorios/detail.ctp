<?php
    $this->assign('title', 'Detalhes de Pagamento');
...
<div class="dashboard-container">
    <div class="ngproc-card">
        <div class="ngproc-card-title">
            ...
            <?= $this->Html->link("< Cotações", ['action' => 'cotation'], ['class' => 'btn', 'id' => 'voltar']); ?>
        </div>
        <!-- ========================================
        ...
        <div class="ngproc-card-content">
            <div class="row">
                ...
                <div class="col-md-8" style="margin-bottom:10px">
                    ...
                    <div class="row" style="margin: 0 0 30px 3px">
                        <div class="col-md-12" style="margin-bottom:15px">
                            <strong>PARCEIRO</strong>
                        </div>
                        <div class="col-md-1">
                            <label>ID:</label>
                            <p><?= $cotation->user_id ?></p>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <p><?php
                                $msg = null;
                                if(!empty($cotation->user->cellphone) ){
                                   $msg = $cotation->user->cellphone;
                                }
                                if(!empty($cotation->user->telephone)){
                                    if(!empty($msg)){
                                        $msg = $msg . ' ou ' . $cotation->user->telephone;
                                    }else{
                                        $msg = $cotation->user->telephone;
                                    }
                                }
                                if(empty($msg)){ echo '---'; }
                                else{ echo $msg; }
                    ...
                    <div class="row" style="margin: 0 0 30px 3px">
                        ...
                        <div class="col-md-1">
                            <label for="">ID:</label>
                            <p><?= $cli_cotation->user->id ?></p>
                        </div>
                        <div class="col-md-3">
                            <label for="">Nome:</label>
                            <p><?= $cli_cotation->user->name ?></p>
                        </div>
                        <div class="col-md-4">
                            <label for="">E-mail:</label>
                            <p><?= $cli_cotation->user->email ?></p>
                        </div>
                        <div class="col-md-4">
                            <label for="">Contato:</label>
                            <p><?php
                                $msg = null;
                                if(!empty($cli_cotation->user->cellphone) ){
                                   $msg = $cli_cotation->user->cellphone;
                                }
                                if(!empty($cli_cotation->user->telephone)){
                                    if(!empty($msg)){
                                        $msg = $msg . ' ou ' . $cli_cotation->user->telephone;
                                    }else{
                                        $msg = $cli_cotation->user->telephone;
                                    }
                                }
                                if(empty($msg)){ echo '---'; }
                                else{ echo $msg; }
                        ...
                        <div class="col-md-6">
                            <label for="">CPF:</label>
                            <p><?= empty($cli_cotation->user->doc_cpf) ? '---' : $cli_cotation->user->doc_cpf; ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom:30px">
                ...
                <div class="col-md-8" style="margin-top:10px">
                    ...
                    <div class="col-md-12">
                        <label for="">Site:</label>
                        <p><a href="<?=$ct_provider->provider->site ?>" target="_blank"><?= $ct_provider->provider->site ?></a></p>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php if($item->provider_id == $ct_provider->provider_id): ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center"><a href="<?= $item->link_item ?>" target="_blank"><?= $item->link_item ?></a></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php endforeach; ?>
                                </tbody>
